...
const Verification = () => {
  const [verifications, setVerifications] = useState([
    { _id: '1', name: 'Olivia Bennett', role: 'Event Organizer', date: '2023-02-20', status: 'Pending Review' },
    { _id: '2', name: 'Ethan Hayes', role: 'Gig Worker', date: '2023-02-19', status: 'Pending Review' },
    { _id: '3', name: 'James Rodriguez', role: 'Event Organizer', date: '2023-02-18', status: 'Rejected' },
    { _id: '4', name: 'Sophia Chen', role: 'Gig Worker', date: '2023-02-17', status: 'Approved' },
  ]);
